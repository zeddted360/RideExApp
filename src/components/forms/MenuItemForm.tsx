            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  For showing discounts (leave blank if no discount)
                </p>
              ...
              <div>
                ...
                <div className="relative mt-1.5">
                  <Input
                    ...
                    disabled={loading}
                  />
                  <Star className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-yellow-500" />
                </div>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Rate from 0 to 5</p>
              ...
              {imagePreview ? (
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                    Recommended: JPG or PNG, max 5MB, square format works best
                  </p>
                </div>
              )}
              {getFieldError("image") && (
