...
import { Edit2, Loader2, PlusCircle, Trash2, ChevronDown, ChevronUp, X, Image as ImageIcon, Info, Sparkles, DollarSign, Upload } from "lucide-react";
...
const ExtrasManagementForm = () => {
  ...
  return (
    <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Additional cost for this extra</p>
                    {getFieldError("price") && (
                      <p className="text-red-500 text-xs mt-1.5 flex items-center gap-1">
                        <Info className="w-3 h-3" />
                  ...
                  <div className="bg-orange-50 dark:bg-orange-950/20 border border-orange-200 dark:border-orange-800 rounded-lg p-3 mb-3">
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-xs text-orange-800 dark:text-orange-300">
                        <strong>Pro tip:</strong> Upload a clear image to help customers visualize the extra item.
                      </p>
                    </div>
                  </div>
                  ...
                  {imagePreview ? (
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                        Recommended: High-resolution JPG or PNG, max 5MB, square format
                      </p>
                    </div>
                  )}
                  {getFieldError("image") && (
      ...
      <Card id="extras-list" className="w-full bg-white/80 dark:bg-gray-900/80 shadow-2xl rounded-2xl border-0 py-4">
            ...
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {visibleExtras.map((extra: IFetchedExtras) => (
                  <Card key={extra.$id} className="bg-white/80 dark:bg-gray-900/80 shadow-md rounded-xl border-0 overflow-hidden hover:shadow-xl transition-all duration-200 hover:-translate-y-1">
