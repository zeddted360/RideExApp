...
import { Star, Clock, MapPin, ShoppingCart, Loader2, ArrowLeft, Badge, Users } from 'lucide-react';
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        // Fetch restaurant by name (assuming [id] is a name slug)
        const restaurantResponse = await databases.listDocuments(
          validateEnv().databaseId,
          validateEnv().restaurantsCollectionId, 
          [Query.equal("name", decodedId)] 
        );

        if (!restaurantResponse.documents || restaurantResponse.documents.length === 0) {
          throw new Error('Restaurant not found');
        }

        const restaurantDoc = restaurantResponse.documents[0] as IRestaurantFetched;
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center">
        <div className="text-center bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Loading Restaurant</h3>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center">
        <div className="text-center bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl max-w-md mx-4">
          ...
          <p className="text-red-600 dark:text-red-400 mb-6">{error || 'Restaurant not found'}</p>
          <Link href="/">
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="relative bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          {/* Back Button */}
          <Link href="/" className="inline-flex items-center text-orange-100 hover:text-white transition-colors mb-8 group">
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-8">
            ...
            <div className="flex-1">
              <div className="mb-4">
                ...
                <div className="inline-flex items-center bg-white/10 backdrop-blur-sm px-3 py-1 rounded-full">
                  <span className="text-orange-100 text-sm font-medium">{restaurant.category}</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center">
                  ...
                  <div className="text-lg font-bold">{restaurant.deliveryTime}</div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center">
                  ...
                  <div className="text-lg font-bold">{restaurant.distance}</div>
                  <div className="text-xs text-orange-100">Away</div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3">
              <Button asChild size="lg" className="bg-white hover:bg-gray-50 text-orange-600 font-semibold shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
                <Link href="/cart">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">Our Menu</h2>
            <p className="text-gray-600 dark:text-gray-400">Discover our delicious offerings</p>
          </div>
          {menuItems.length > 0 && (
        ...
        {menuItems.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">No Menu Items Yet</h3>
            <p className="text-gray-500 dark:text-gray-400 mb-6 max-w-md mx-auto">
              This restaurant hasn't added any menu items yet. Please check back later or contact them directly.
            </p>
            <Link href="/">
              <Button variant="outline" className="border-orange-200 text-orange-600 hover:bg-orange-50 dark:border-orange-800 dark:text-orange-400 dark:hover:bg-orange-950">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
            {menuItems.map((item) => (
              <RestaurantMenuItem key={item.$id} item={item} restaurantId={restaurant.$id} /> 
            ))}
          </div>
        )}
      </div>
